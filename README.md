...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-gpnztz8.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-gpnztz8.containers.anotherwebservice.com/
...
```
git clone git@github.com:wofly98/container-gpnztz8.git
cd container-gpnztz8
```
...
```
docker attach container-gpnztz8
```
